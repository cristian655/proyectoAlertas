...
# 🔹 Configuración de conexión a la base de datos AWS (⚠️ Reemplaza la contraseña manualmente)
DB_CONFIG = {
    "user": "master_admin",
    "password": "TU_CONTRASEÑA_AQUÍ",  # ⚠️ No almacenes contraseñas en código público
...
if __name__ == "__main__":
    ...
    # Obtener datos llamando al procedimiento almacenado en AWS
