...
def enviar_resumen_diario():
    ...
    <body style="font-family: Arial, sans-serif;">
        <div style="max-width: 800px; margin: auto; text-align:center;">
            <img src="cid:logo_gp" alt="GP Consultores" style="width:120px; margin-bottom: 15px;" />
    ...
    # Adjuntar el logo como inline, no como adjunto normal
